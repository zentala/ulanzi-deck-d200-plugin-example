...
Stack: plain JS (no module system, browser-style globals), Jest tests in a `vm` sandbox, ESLint + Prettier + Husky pre-commit. UUIDs centralised in [`plugin/uuids.js`](ulanzi-demos/plugins/demo/io.zentala.ulanzideck.demo.ulanziPlugin/plugin/uuids.js). 126 unit + dispatcher + manifest tests.

### What it looks like

Button renders are captured deterministically (fixed clock 09:41, mocked fetch) by `pnpm previews`; the pre-commit hook auto-regenerates them when any action changes, so these screenshots never drift from the code.

| Clock | Counter | CPU Status | Calendar |
|:---:|:---:|:---:|:---:|
| ![Clock](ulanzi-demos/plugins/demo/io.zentala.ulanzideck.demo.ulanziPlugin/assets/previews/clock.png) | ![Counter](ulanzi-demos/plugins/demo/io.zentala.ulanzideck.demo.ulanziPlugin/assets/previews/counter.png) | ![Status](ulanzi-demos/plugins/demo/io.zentala.ulanzideck.demo.ulanziPlugin/assets/previews/status.png) | ![Calendar](ulanzi-demos/plugins/demo/io.zentala.ulanzideck.demo.ulanziPlugin/assets/previews/calendar.png) |

| Pomodoro idle | Pomodoro working | Weather (clear) | Weather (rain) |
|:---:|:---:|:---:|:---:|
| ![Pomodoro idle](ulanzi-demos/plugins/demo/io.zentala.ulanzideck.demo.ulanziPlugin/assets/previews/pomodoro-idle.png) | ![Pomodoro work](ulanzi-demos/plugins/demo/io.zentala.ulanzideck.demo.ulanziPlugin/assets/previews/pomodoro-work.png) | ![Weather clear](ulanzi-demos/plugins/demo/io.zentala.ulanzideck.demo.ulanziPlugin/assets/previews/weather-clear.png) | ![Weather rain](ulanzi-demos/plugins/demo/io.zentala.ulanzideck.demo.ulanziPlugin/assets/previews/weather-rain.png) |

Full WMO weather matrix (8 conditions + loading + offline) and notes on the regen pipeline live in [the plugin's own README](ulanzi-demos/plugins/demo/io.zentala.ulanzideck.demo.ulanziPlugin/README.md#action-previews).
